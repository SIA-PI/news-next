...
export default function DashboardPage() {
  ...
  const chartTooltipBgColor =
    theme === 'dark' ? 'rgba(15, 23, 42, 0.8)' : 'rgba(255, 255, 255, 0.9)';
  const chartTooltipBorderColor =
    theme === 'dark' ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.1)';
  const chartTooltipTitleColor = theme === 'dark' ? '#ffffff' : '#000000';
  const chartTooltipBodyColor = theme === 'dark' ? '#cbd5e1' : '#374151';
